      ...
      <div>
        <div id="characterChoiceBar">
          ...
          <div id="moveSelectionRow">
            <Link id="previousMoveLink" to={prevMove !== undefined ? `/${currentCharacterData.value}/${prevMove.value}` : "#"}>
              <span
                data-tooltip-id="previousMoveToolTip"
            ...
            <Link id="nextMoveLink" to={nextMove !== undefined ? `/${currentCharacterData.value}/${nextMove.value}` : "#"}>
              <span
                data-tooltip-id="nextMoveToolTip"
