...
function DataTable(props) {
  ...
  let fields = {
    ...
    hitboxesExtraNoFrame: [hitboxFields["id"], hitboxFields["part"],hitboxFields["damage"], hitboxFields["shielddamage"], hitboxFields["angle"], hitboxFields["bkb"], hitboxFields["kbg"], hitboxFields["fkb"], hitboxFields["trip"], hitboxFields["sdi"], hitboxFields["ground_or_air"], hitboxFields["size"], hitboxFields["rehit"], hitboxFields["bone"], hitboxFields["x"], hitboxFields["y"], hitboxFields["z"], hitboxFields["setweight"], hitboxFields["clang_rebound"], hitboxFields["reflectable"], hitboxFields["absorbable"], hitboxFields["flinchless"], hitboxFields["facingrestrict"], hitboxFields["effect"], hitboxFields["type"], hitboxFields["hitbits"], hitboxFields["notes"], hitboxFields["more"]],
    ...
    hitboxesExtra: [hitboxFields["id"], hitboxFields["part"], hitboxFields["frames"],hitboxFields["damage"], hitboxFields["shielddamage"], hitboxFields["angle"], hitboxFields["bkb"], hitboxFields["kbg"], hitboxFields["fkb"], hitboxFields["trip"], hitboxFields["sdi"], hitboxFields["ground_or_air"], hitboxFields["size"], hitboxFields["rehit"], hitboxFields["bone"], hitboxFields["x"], hitboxFields["y"], hitboxFields["z"], hitboxFields["setweight"], hitboxFields["clang_rebound"], hitboxFields["reflectable"], hitboxFields["absorbable"], hitboxFields["flinchless"], hitboxFields["facingrestrict"], hitboxFields["effect"], hitboxFields["type"], hitboxFields["hitbits"], hitboxFields["notes"], hitboxFields["more"]],
